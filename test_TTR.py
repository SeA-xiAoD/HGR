...
# divide dataset
training_data_x = data_x[:int(len(data_x) * (1-TTR))]
val_data_x = data_x[int(len(data_x) * (1-TTR)):]

training_data_y = data_y[:int(len(data_y) * (1-TTR))]
val_data_y = data_y[int(len(data_y) * (1-TTR)):]
