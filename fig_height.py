...
# load data
data_x = np.load("/home/wsn/Desktop/HAR/HGR_dataset/height_data/15cm_x_128.npy")
data_y = np.load("/home/wsn/Desktop/HAR/HGR_dataset/height_data/15cm_y_128.npy")
...
#             mat[i,j] = 0
#         else:
#             mat[i,j] = round(mat[i,j]/640, 4)
    
print(mat)
plt.rc("font", family="Times New Roman", size=12)
plt.rcParams['savefig.dpi'] = 200 #图片像素
plt.rcParams['figure.dpi'] = 200
plot_confusion_matrix(mat, classes=['0','1','2','3','4','5','6'], title="15cm (Accuracy = 0.3844)")
plt.savefig('/home/wsn/Desktop/HAR/result_figure/Figure_height_15cm.eps', bbox_inches='tight', restarized=True, format="eps")
plt.show()